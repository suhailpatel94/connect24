		...
		function getTransform7CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('-65%',	-350,	0,	-1,	1,	'visible'),

					getTransform3dCSS('70%', 	-300, 	0,	0,	1,	'visible'),
					getTransform3dCSS('200%', 	-200, 	0,	1,	1,	'visible'),
					getTransform3dCSS('330%', 	0, 		0,	2,	1,	'visible'),
					getTransform3dCSS('465%', 	-200, 	-0,	1,	1,	'visible'),
				...
				cssArray = [
					...
					getTransform2dCSS('-65%',	0.6,	'100%',		'50%',	1,	'visible'),

					getTransform2dCSS('70%', 	0.7,	'100%',		'50%',	1,	'visible'),
					getTransform2dCSS('200%', 	0.8,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('330%', 	1,		'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('465%', 	0.8,	'50%',		'50%',	1,	'visible'),
		...
		function getTransform5CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('-100%', 	-500, 	0,	0,	1,	'visible'),
					getTransform3dCSS('70%', 	-200, 	0,	1,	1,	'visible'),
					getTransform3dCSS('200%', 	0, 		0,	2,	1,	'visible'),
					getTransform3dCSS('330%', 	-200, 	-0,	1,	1,	'visible'),
					getTransform3dCSS('500%', 	-500, 	-0,	0,	1,	'visible'),
				...
				cssArray = [
					...
					getTransform2dCSS('70%', 	0.8,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('200%', 	1,		'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('330%', 	0.8,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('500%', 	0.7,	'0%',		'50%',	1,	'visible'),
		...
		function getTransform3CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('-35%', 	-300, 	0,	1,	1,	'visible'),
					getTransform3dCSS('100%', 	0, 		0,	2,	1,	'visible'),
					getTransform3dCSS('235%', 	-300, 	-0,	1,	1,	'visible'),

					getTransform3dCSS('330%', 	-400, 	-0,	0,	0,	'hidden')
				];
			} else if(support2d){
				cssArray = [
					getTransform2dCSS('-100%',	0.65,	'100%',		'50%',	0,	'hidden'),

					getTransform2dCSS('-35%', 	0.8,	'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('100%', 	1,		'50%',		'50%',	1,	'visible'),
					getTransform2dCSS('235%', 	0.8,	'50%',		'50%',	1,	'visible'),

					getTransform2dCSS('330%', 	0.65,	'0%',		'50%',	0,	'hidden')
				];
			}
		...
		function getTransform1CSS(){
			...
			if(support3d){
				cssArray = [
					...
					getTransform3dCSS('0%', 	-350, 		0,	2,	1,	'visible'),
